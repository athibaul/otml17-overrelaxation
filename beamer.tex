...
\end{center}
\pause
Sufficient condition: ensure that the smallest  coordinate of $\varphi_\theta \left((A_k \gamma) \oslash \mu^k \right)$ is strictly positive
\end{frame}
...
\begin{frame}{Advantages of this choice}
	...
	\end{itemize}
	\pause
	If SK converges at rate $1-\eta$, $\theta_0 = \frac{2}{1+\sqrt{\eta}}$ is asymptotically optimal.
\end{frame}
