	...
	\begin{minipage}{0.45\textwidth}
		...
		\begin{tcolorbox}[width=0.99\textwidth,/tcb/size=small, /tcb/top=2.0mm]
			...
			\begin{tabular}{c c c c}
				...
				$\epsilon = 0.02$
			\end{tabular}
			\captionof{figure}{Regularized optimal transport maps become more and more precise for decreasing regularization parameter $\epsilon$.} \label{fig:1d_ot}
		\end{tcolorbox}
	\end{minipage}
}
...
\headerbox{Experiments}{name=expe,below=overrelaxation,column=1,span=2}{
	...
	\begin{minipage}{0.4\textwidth}
		\begin{tcolorbox}[size=small]
			\centering
			\includegraphics[width=0.83\textwidth]{typical_convergence_2} \\
			\captionof{figure}{Typical run of the algorithm: value of the Lyapunov function and of the overrelaxation parameters during the iterations.}
		\end{tcolorbox}
	\end{minipage}
}
