...
\headerbox{Introduction}{name=intro,column=0,span=2}{
	\begin{minipage}{0.55\textwidth}
		\begin{itemize}
			...
			\item[] To counter the slowing of SK for small $\epsilon$, we propose a new algorithm based on \emph{overrelaxation}.
			Global convergence is ensured by choosing the overrelaxation parameters at each step of the algorithm so that a given Lyapunov function decreases.
