...
\headerbox{Introduction}{name=intro,column=0,span=2}{
	\begin{minipage}{0.55\textwidth}
		...
		The algorithm we obtain converges between 2 and 20 times faster than Sinkhorn--Knopp, while remaining parallelizable, and having almost the same cost per iteration.
	\end{minipage}
...
\headerbox{References}{name=references,below=overrelaxation,column=1}{
	\small
