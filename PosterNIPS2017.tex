...
\headerbox{Lyapunov Function}{name=lyapunov,column=1,below=overrelaxation,bottomaligned=Sinkhorn}{
    ...
    It is motivated by the fact that this function decreases for regular Bregman projections.
    Moreover, we can check numerically
    ...
    \begin{minipage}{0.65\textwidth}
    	...
    	\end{equation*}
    	We want this quantity to be positive. A sufficient condition is that every coordinate of $\varphi_\theta \left((A_k \gamma) \oslash \mu^k \right)$ be positive. Functions $\theta_1, \theta_2$ are crafted for this purpose.
    	\begin{align*}
...
\headerbox{Experiments}{name=expe,below=Sinkhorn,column=0,span=2}{
...
\headerbox{References}{name=references,below=expe,span =2}{
