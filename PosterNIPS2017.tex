...
\end{minipage}
But in general, there is no proof of global convergence for iterative overrelaxed Bregman projections. In order to ensure convergence, we use a Lyapunov function.
}
