...
\end{equation}
where $\gamma^*$ is the solution to the regularized OT problem (the largest eigenvalue is $1$, associated to the eigenvector $\mathbf{1}$). We denote this second largest eigenvalue by $1-\eta$, which satisfies $\eta>0$ (see \cite{knight2008sinkhorn}).
