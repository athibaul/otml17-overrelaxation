...
\end{proof}
Thus, calculating the decrease in value of the function $F$ is  cheap ($o(n_k)$) and straightforward. In Figure \ref{phi_omega}, we illustrate the functions  $\varphi_\omega$ for several values of $\omega$.
