...
\end{equation}
where $\gamma^*$ is the solution to the regularized OT problem. We denote this second largest eigenvalue by $1-\eta$, which satisfies $\eta>0$ (see \cite{knight2008sinkhorn}).
