...
\begin{abstract}
This article describes a method for quickly calculating the solution to the regularized optimal transport problem. It generalizes and improves upon the widely-used iterative Bregman projections algorithm (or Sinkhorn's algorithm). 
...
In this paper, we propose a simple method for establishing the global convergence of the over-relaxed Sinkhorn's algorithm, by ensuring the decrease of a Lyapunov function at each step.
